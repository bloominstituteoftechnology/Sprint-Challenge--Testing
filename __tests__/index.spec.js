...
describe('server.js', () => {
  ...
  describe('GET /games endpoint', () => {
    ...
    it('should return a JSON object from /games', async () => {
      const expectedBody =   [{"genre": "Arcade", "releaseYear": 1980, "title": "Pacman"}, {"genre": "Arcade", "releaseYear": null, "title": "Pole Position"}, {"genre": "Strategy/Simulation", "releaseYear": 1999, "title": "Pharaoh"}]
