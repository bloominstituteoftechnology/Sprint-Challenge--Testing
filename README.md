...
- Describe() is used to identify what is being tested, and it() is used to perform an individual test.  


2. What is the point of `Test Driven Development`? What do you think about this approach?

- The point of Test Driven Development is to reduce the risk of regressions and minimize the number of bugs that may appear in production.  
