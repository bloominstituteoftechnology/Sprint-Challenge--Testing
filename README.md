...
Describe is to group tests and describe then in a more organized way, 'it' is the same as test but it allows you to run several assertions

1. What is the point of `Test Driven Development`? What do you think about this approach?

It forces you to write test first and then the fucntionality that its been tested, it allows you to think upfront about all edge cases and makes sure your code is high quality. I like this approach, its not easy thought
