...
| --- | --- | --- |
| id | string | The game document whose name property you want to update.
| name | string | The new name for the specified game. |
...
| Name | Type | Description |
| --- | --- | --- |
| name | string | The name of the game you want to add to the database. |
