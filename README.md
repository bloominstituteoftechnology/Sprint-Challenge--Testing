...
1. In Jest, what are the differences between `describe()` and `it()` globals, and what are good uses for them?
    ...
    `describe()` is the container that multiple `it()`'s can go into, where the `it()`'s are the test performed

2. What is the point of `Test Driven Development`? What do you think about this approach?

    you are making the app tests before the app itself, it cant get any more tested than that LOL
    the tests 'drive' the development

3. Mention three types of automated tests.

    automated unit tests, automated GUI tests, component tests and many more 
