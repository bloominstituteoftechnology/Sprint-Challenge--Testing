...
Describe tells you what environment you're testing and it tells you what in that environment you'll be testing.
...
Unit test, end to end and integration test.
