...
Describe is a description of your functionality while it are the steps you take and what it expects.
1. What is the point of `Test Driven Development`? What do you think about this approach? To test make sure the functionality works before making on to another block of code.
1. Mention three types of automated tests.
unit testing, data driven testing and integration tests. 
## Project Set Up
